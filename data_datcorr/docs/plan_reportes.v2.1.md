...
📄 PLAN DE REPORTES ACTUALIZADO (v2.1 - RESPECTO AL EXISTENTE)
Plan de Reportes - DatCorr ERP (v2.1 - Adaptado)
Estado actual
...
8. GET /reportes/exportar?formato=pdf
   ...
   Tabs	Alternar entre distintos reportes (se integra con el dashboard existente)
   Layout sugerido (MANTIENE TABS)
   text

┌─────────────────────────────────────────────────────────────┐
│  Dashboard (SECCIÓN EXISTENTE)                              │
│  [Widgets de KPIs, Gráficos, Alertas]                       │
├─────────────────────────────────────────────────────────────┤
│  Reportes (SECCIÓN NUEVA)                                    │
│  ┌─────────────────────────────────────────────────────────┐ │
│  │ Tabs: [Resumen] [Actividad] [Usuarios] [Bases] [Alertas] │ │
│  └─────────────────────────────────────────────────────────┘ │
│  ┌─────────────────────────────────────────────────────────┐ │
│  │  Tab 1: KPIs + Tablas paginadas                         │ │
│  └─────────────────────────────────────────────────────────┘ │
│  ┌─────────────────────────────────────────────────────────┐ │
│  │  Tab 2: Gráficos + Tablas paginadas                     │ │
│  └─────────────────────────────────────────────────────────┘ │
│  ...                                                        │
└─────────────────────────────────────────────────────────────┘
...
Integración: respetar el diseño existente del dashboard con tabs para navegación
Posibles mejoras futuras
Reportes programados via cron/scheduler (enviar por email)
Dashboard de reportes con widgets configurables por usuario (futura versión)
...
Frontend: componentes de tabs (reutilizable)
Frontend: pagina (ReportesPage.jsx) con Tabs
...
Nota: Este plan v2.1 mantiene la propuesta de widgets pero los integra dentro de tabs para respetar el diseño existente del dashboard. Esto evita romper lo ya implementado mientras ofrece la misma funcionalidad inteligente.
